...
export const terms = {
  ...
  lsa: {
    term: "LSA",
    full: "Link-State Advertisement",
    def: "ชิ้นส่วนแผนที่ที่ Router หนึ่งตัวสร้างขึ้นเพื่อบอกว่า \"ฉันมีลิงก์อะไรบ้าง สภาพเป็นยังไง cost เท่าไหร่\" แล้วส่งกระจายให้ทุกตัวใน Area — เอามาต่อกันครบทุกใบเมื่อไหร่ก็ได้แผนที่ทั้งผืน",
  },
  lsdb: {
    term: "LSDB",
    full: "Link-State Database",
    def: "คลังที่เก็บ LSA ทุกใบที่ได้รับมา = แผนที่ทั้งผืนของ Area นั้น — Router ทุกตัวใน Area เดียวกันต้องมี LSDB เหมือนกันเป๊ะ ถ้าไม่เหมือนแปลว่ามีอะไรผิดปกติ",
  },
  dijkstraSpf: {
    term: "SPF",
    full: "Shortest Path First (Dijkstra)",
    def: "อัลกอริทึมที่กาง LSDB ออกมาแล้วคำนวณหาเส้นทางที่ cost รวมต่ำที่สุดไปยังทุกปลายทาง โดยตั้งตัวเองเป็นจุดเริ่ม — ผลลัพธ์คือ SPT ที่แต่ละ Router ได้ไม่เหมือนกันเพราะยืนคนละจุด",
  },
  flooding: {
    term: "Flooding",
    full: "",
    def: "การส่ง LSA ต่อออกไปทุกทางที่เปิด OSPF อยู่ (ยกเว้นทางที่รับเข้ามา) เพื่อให้กระจายทั่ว Area อย่างรวดเร็ว — ต่างจาก Update ของ Distance Vector ที่ส่งให้เฉพาะเพื่อนบ้านแล้วจบ",
  },
  adjacency: {
    term: "Adjacency",
    full: "",
    def: "ความสัมพันธ์ระดับลึกที่สอง Router แลก LSDB กันจนตรงกันแล้ว (state = Full) — ต่างจากคำว่า Neighbor เฉย ๆ ที่แค่รู้จักกันแต่ยังไม่ได้แลกฐานข้อมูล",
  },
  convergence: {
    term: "Convergence",
    full: "",
    def: "ช่วงเวลาตั้งแต่เครือข่ายเปลี่ยน (สายขาด/ลิงก์เพิ่ม) จนถึงตอนที่ Router ทุกตัวรับรู้และปรับเส้นทางเสร็จเรียบร้อยตรงกันหมด — ยิ่งสั้นยิ่งดี",
  },
  redistribution: {
    term: "Redistribution",
    full: "",
    def: "การหยิบเส้นทางจากโปรโตคอลหนึ่งไปยัดใส่อีกโปรโตคอลหนึ่ง เช่น เอาเส้นทางจาก BGP เข้ามาใน OSPF — Router ที่ทำหน้าที่นี้ในโดเมน OSPF เรียกว่า ASBR",
  },
  igp: {
    term: "IGP",
